...
namespace Kyobo_Msg_Client
{
    ...
    public sealed class MainProg
    {
        ...
        public static void ConfigGetProfile()
        {
            ...
            GetPrivateProfileString("CONFIG", "ServerIP", "127.0.0.1", ret, 16, IniFilePath);
        ...
        public void ConfigWriteProfile(String userID, String ip, String port)
        {
            String IniFilePath = Environment.CurrentDirectory + @"\Config.ini";
            String path = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\Kico\\Received Files";
            ...
            //FTP설정
            WritePrivateProfileString("CONFIG", "FtpPath", @"ftp://10.65.21.154/web/temp/", IniFilePath);
            WritePrivateProfileString("CONFIG", "FtpUser", "admin", IniFilePath);
            WritePrivateProfileString("CONFIG", "FtpPass", "Great2016!^", IniFilePath);
        ...
        {
            cConf.userList = new _Sel().GetListHashData(null, "getUserInfo")
